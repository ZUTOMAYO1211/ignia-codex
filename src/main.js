...
function home() {
  ...
  <section class="unfinished"><div><span class="section-kicker">미정</span><h2>아직 정하지 않은 것들</h2><p>국가 정식 명칭·창세 가설·주사위 판정 여부처럼 원문에 🚧로 남겨 둔 항목</p></div><a href="#pending">미정 항목 보기 ↗</a></section>`;
}
